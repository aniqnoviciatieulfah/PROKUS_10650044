...
--
-- Host: localhost
-- Waktu pembuatan: 19. Maret 2013 jam 08:52
-- Versi Server: 5.5.16
-- Versi PHP: 5.3.8
...
(1, '2012-12-15 00:00:00', '2013-01-07 00:00:00', 'Liburan Akhir Semester', 'Liburan akhir semester dimulai tanggal 20 Desember 2012 sampai dengan 6 Januari 2013', '#FF0000', 1, 1, 1);

-- --------------------------------------------------------

--
-- Struktur dari tabel `calendarevent_picture`
--
...
--
-- Dumping data untuk tabel `calendarevent_picture`
--
...
--
-- Struktur dari tabel `soal_hasil`
--
...
--
-- Struktur dari tabel `soal_jawab`
--
...
--
-- Struktur dari tabel `soal_kelas`
--
...
--
-- Struktur dari tabel `soal_utama`
--
...
--
-- Dumping data untuk tabel `t_banner`
--

INSERT INTO `t_banner` (`id`, `alt`, `url`, `visits`, `status`, `admin`, `aktif`, `jenis`) VALUES
(3, 'edukasi', 'http://e-dukasi.net', 2, 12, 2, '1', 'jpg'),
(5, 'wikipedia Indonesia', 'http://id.wikipedia.org', 2, 12, 2, '1', 'jpg'),
(11, 'Banner SD', 'http://www.kajianwebsite.org', 4, 13, 3, '1', 'jpg');
...
--
-- Struktur dari tabel `t_belajar_detail`
--
...
--
-- Struktur dari tabel `t_belajar_kls`
--
...
--
-- Struktur dari tabel `t_belajar_log`
--
...
--
-- Struktur dari tabel `t_download`
--
...
--
-- Dumping data untuk tabel `t_download`
--

INSERT INTO `t_download` (`id`, `judul`, `deskripsi`, `kategori`, `file`, `visit`, `ukuran`, `tanggal`) VALUES
(15, 'Modul Agama Islam', 'Modul Agama Islam', 'Pendidikan Agama', 'al15.pdf', 0, '37,07 Kbytes', '16/12/2012 13:08:00'),
(14, 'Aritmatika Sosial Kelas VI', 'Aritmatika Sosial', 'Matematika', 'al14.pdf', 0, '68,46 Kbytes', '16/12/2012 10:03:08');

-- --------------------------------------------------------

--
-- Struktur dari tabel `t_dsp`
--
...
--
-- Struktur dari tabel `t_forum_balas`
--
...
--
-- Struktur dari tabel `t_forum_isi`
--
...
--
-- Struktur dari tabel `t_forum_moderator`
--
...
--
-- Dumping data untuk tabel `t_forum_moderator`
--
...
--
-- Struktur dari tabel `t_galerialbum`
--
...
--
-- Dumping data untuk tabel `t_galerialbum`
--

INSERT INTO `t_galerialbum` (`idalbum`, `album`, `tanggal`) VALUES
(1, 'Kegiatan Sekolah', '16-12-2012');

-- --------------------------------------------------------

--
-- Struktur dari tabel `t_gambaratas`
--
...
--
-- Dumping data untuk tabel `t_gambaratas`
--
...
(4, '<p>Rapat kerja tahun 2008 akan diselenggarakan pada tanggal 20 - 25 November 2008. Kegiatan akan membahas tentang RAPBS tahun 2008-2009 dan Pemilihan wakil kepala sekolah.</p>', 'Rapat kerja Guru SD', '16/12/2012'),
...
(6, '<p>Downl</p>', 'Download Blanko UN SD', '16/12/2012');
...
('1', '400001001', '1', '-'),
('5', '196805181995121004', '5', '-'),
('4', '196504281989121001', '4', '-'),
('3', '196105221984031005', '3', '-'),
('2', '400001003', '2', '-'),
...
('X MM 1', '400001003', '1', 'IPA'),
('X MM 2', '400001001', '1', 'Multimedia'),
('6', '400001004', '6', '-');
...
(1, 'www.kemdikbud.go.id', 'Website Departemen Pendidikan dan Kebudayaan', 1);
...
(2, 'Dody Firmansyah', '01-01-1983', 'm', 'Guru', 'Jl. Kol Enjo Martadisastra No.15 Bogor', 'Ind', '081317579751', 'SMK Negeri 1 Bogor', 'www.kickdody.com', 'Web Programming, 3 Dimensi dan Visual Efek', 'kickdody', 'e10adc3949ba59abbe56e057f20f883e', 'kickdody@yahoo.com', '1', 'aa', '2', '1', '2009-10-29 15:22:47', '400001002', '-', 'Guru', '0', 1, 103, '0', 41, '127.0.0.1', 'open', NULL),
(1, 'BAYU ALI AKBAR', '03-02-1993', 'm', 'Siswa', 'Jl. Bojongkokosan No.24 Antapani Bandung2', 'Ind', '32423423', 'SMA NEGERI 4 BANDUNG', 'bayu.wordpress.com', 'saya adalah .....', '070810120', 'e10adc3949ba59abbe56e057f20f883e', 'alan@alanrm.net', '2', '123456', '1', '1', '2011-04-28 14:01:26', '070810120', 'X - 4', 'Siswa', '1', 7, 823, '0', 174, '127.0.0.1', 'open', NULL),
(3, 'Alan Ridwan M', '01-01-1995', 'm', 'Guru', 'Jl. Bojongkokosan No.24 Antapani Bandung', 'Ind', '085624070482', 'SMA NEGERI 4 BANDUNG', 'www.alanrm.com', 'Web Programming', 'alan', '894a9b94bcc5969b60bd18e8ea9c0ddc', 'alanrm82@yahoo.com', '1', 'a', '3', '1', '2012-06-13 18:05:01', '400001001', 'undefined', 'Guru', '1', 7, 256, '0', 115, '127.0.0.1', 'open', ''),
...
(4, 'Taufik N. Syah, S.Pd', '01-01-1995', 'm', 'Guru', 'Komplek Timah Jl. Margasatwa, Pondok Labu Jakarta Selatan ', 'ID', '081388334414', 'SMKN 41 Jakarta', '-', 'SMKN 41 Jakarta', 'taufikns@yahoo.com', '6f518c31f6baa365f55c38d11cc349d1', 'taufikns@yahoo.com', '1', '1', '3', '1', '2012-11-27 03:30:01', '400001003', '-', 'Guru', '0', 1, 11, '1', 9, '::1', 'open', NULL),
...
(5, 'Siswanto, S.Pd', '01-01-1995', 'm', 'Guru', 'Jl. Kapi anala 4 Malang', 'ID', '081233081768', 'SMA Negeri 10 Malang', 'www.tesdigital.com', 'siswanto-mlg@telkom.net', 'siswanto', 'e10adc3949ba59abbe56e057f20f883e', 'siswanto-mlg@telkom.net', '1', '1', '0', '1', '2009-10-29 15:21:11', '196805181995121004', '-', 'Guru', '0', 1, 3, '0', 2, '127.0.0.1', 'open', NULL),
...
--
-- Struktur dari tabel `t_memberfoto`
--
...
--
-- Struktur dari tabel `t_memberfoto_album`
--
...
--
-- Struktur dari tabel `t_memberfoto_kom`
--
...
--
-- Struktur dari tabel `t_membergroup`
--
...
--
-- Struktur dari tabel `t_membergroup_anggota`
--
...
--
-- Struktur dari tabel `t_membergroup_diskusi`
--
...
--
-- Struktur dari tabel `t_membergroup_diskusibalas`
--
...
--
-- Struktur dari tabel `t_membergroup_info`
--
...
--
-- Struktur dari tabel `t_membergroup_infokom`
--
...
--
-- Struktur dari tabel `t_membergroup_jenis`
--
...
--
-- Dumping data untuk tabel `t_membergroup_jenis`
--
...
--
-- Struktur dari tabel `t_memberlihat`
--
...
--
-- Struktur dari tabel `t_memberstatus`
--
...
--
-- Dumping data untuk tabel `t_memberstatus`
--
...
(17, 4, '2012-11-27 03:36:44', 4, 'selamat pagi', '0');

-- --------------------------------------------------------

--
-- Struktur dari tabel `t_memberstatus_kom`
--
...
--
-- Dumping data untuk tabel `t_memberstatus_kom`
--
...
--
-- Struktur dari tabel `t_member_contact`
--
...
--
-- Dumping data untuk tabel `t_member_contact`
--
...
--
-- Struktur dari tabel `t_member_custom`
--
...
--
-- Dumping data untuk tabel `t_member_custom`
--
...
--
-- Struktur dari tabel `t_member_games`
--
...
--
-- Dumping data untuk tabel `t_member_games`
--
...
--
-- Struktur dari tabel `t_member_pesan`
--
...
--
-- Struktur dari tabel `t_nilai_detail`
--
...
('BHSIND', 15, 'Bahasa Indonesia', 'Bahasa. Indonesia', '-'),
('SMUSIK', 17, 'Seni dan Budaya', 'Seni dan Budaya', '-'),
('AGM', 18, 'Pendidikan Agama', 'Pendidikan Agama', '-');
...
--
-- Struktur dari tabel `t_pesan_alum`
--
...
--
-- Dumping data untuk tabel `t_pesan_alum`
--
...
--
-- Struktur dari tabel `t_pos_menu`
--
...
--
-- Dumping data untuk tabel `t_pos_menu`
--

INSERT INTO `t_pos_menu` (`id`, `menu`, `posisi`, `urut`, `kategori`, `fungsi`, `sembunyi`, `idtemp`) VALUES
(1, 'Jajak Pendapat', 'L', 3, 'depan', 'jajak', 't', 1),
(2, 'Agenda', 'R', 5, 'depan', 'tanggal', 't', 1),
(3, 'Statistik', 'L', 3, 'depan', 'statistik', 't', 1),
(4, 'Info Sekolah', 'R', 2, 'depan', 'info', 't', 3),
(5, 'Materi Ajar', 'R', 3, 'profil', 'matpel', 't', 1),
(6, 'Berita Terbaru', 'T', 1, 'depan', 'berita', 't', 3),
(7, 'Visi Misi Sekolah', 'R', 1, 'profil', 'visimisi', 'y', 3),
(50, 'Silabus', 'L', 2, 'siswa', 'silabus', 't', 3),
(31, 'Agenda', 'L', 3, 'siswa', 'tanggal', 't', 3),
(8, 'Statistik', 'R', 2, 'profil', 'statistik', 'y', 1),
(9, 'Selayang Pandang Kepala Sekolah', 'T', 1, 'profil', 'profil', 't', 3),
(10, 'Lokasi Sekolah', 'T', 2, 'profil', 'profil2', 't', 2),
(16, 'Banner', 'T', 2, 'guru', 'banner1', 't', 0),
(14, 'Info Sekolah', 'L', 1, 'guru', 'info', 't', 1),
(41, 'Materi Ajar Terbaru', 'R', 3, 'depan', 'materi', 't', 3),
(15, 'Materi Ajar Terbaru', 'L', 1, 'siswa', 'materi', 't', 1),
(38, 'Pencarian', 'R', 1, 'depan', 'cari', 't', 1),
(39, 'Login Member', 'L', 2, 'depan', 'login', 't', 1),
(40, 'Login Member', 'L', 1, 'profil', 'login', 't', 1),
(11, 'Jajak Pendapat', 'R', 2, 'guru', 'jajak', 't', 1),
(19, 'Jajak Pendapat', 'L', 1, 'alumni', 'jajak', 't', 1),
(13, 'Statistik', 'L', 3, 'guru', 'statistik', 't', 1),
(42, 'Artikel Terbaru', 'T', 3, 'depan', 'artikel2', 't', 3),
(49, 'SIlabus', 'R', 2, 'guru', 'silabus', 't', 3),
(18, 'Banner', 'L', 1, 'depan', 'banner2', 't', 1),
(12, 'Agenda', 'L', 2, 'guru', 'tanggal', 't', 1),
(20, 'Agenda', 'L', 2, 'alumni', 'tanggal', 't', 1),
(51, 'Login Member', 'L', 1, 'siswa', 'login', 'y', 3),
(22, 'Info Sekolah', 'R', 2, 'alumni', 'info', 't', 3),
(23, 'Banner', 'T', 2, 'alumni', 'banner3', 't', 0),
(24, 'Pesan Alumni', 'R', 1, 'alumni', 'pesanalumni', 't', 1),
(21, 'Artikel', 'T', 1, 'alumni', 'artikel', 't', 2),
(43, 'Banner', 'T', 2, 'depan', 'banner1', 't', 0),
(44, 'Banner', 'R', 1, 'profil', 'banner2', 't', 1),
(47, 'Materi Uji', 'R', 1, 'siswa', 'soal', 't', 3),
(34, 'Info Sekolah', 'R', 2, 'profil', 'info', 't', 1),
(35, 'Agenda', 'L', 2, 'profil', 'tanggal', 't', 1),
(48, 'Banner', 'R', 2, 'siswa', 'banner2', 't', 3),
(37, 'Galeri Photo Terbaru', 'R', 2, 'depan', 'galeri', 't', 3),
(52, 'Ulang Tahun Siswa', 'R', 2, 'siswa', 'ultah', 't', 3),
(53, 'Profil Guru', 'T', 0, 'guru', 'guru', 't', 2),
(54, 'Prestasi Siswa', 'T', 0, 'siswa', 'siswa', 't', 2),
(55, 'Banner', 'T', 2, 'siswa', 'banner3', 't', 0),
(56, 'Status Member', 'R', 4, 'depan', 'status_member', 'y', 3);
...
(1, 'Lomba Kebersihan Sekolah', 'Dalam rangka membian sekolah-sekolah, maka pemerintah mengadakan Lomba Lingkungan Sekolah. Alhamdulilah Juara I');
...
(1, 'Home', '-', 1, 0, 'index.php', 0, '_self'),
(2, 'Profil', '-', 2, 0, 'profil.php', 0, '_self'),
...
(28, 'Direktori Guru', '-', 1, 3, 'guru.php?id=dbguru', 0, '_self'),
...
--
-- Struktur dari tabel `t_project_com`
--
...
--
-- Dumping data untuk tabel `t_silabus`
--
...
('12012', 'Hasna Susilawati', '1', 'Jalan Raya Kebun raya', '12/03/2012', '0217876543', 'Islam', 'P', 'Jakarta', '', '', '', ''),
('12013', 'Robby', '1', '', '', '', '', 'L', '', '', '', '', ''),
('12014', 'Linda Bonita', '1', '', '', '', '', 'P', '', '', '', '', ''),
('', 'Ismail Saleh Ramdhan', '1', '', '', '', '', 'L', '', '', '', '', ''),
('12015', 'Muhammad Aqil Al-Hadar', '1', '', '', '', '', 'L', '', '', '', '', ''),
('12018', 'Asmawati Sholeha Amiruddin', '2', '', '', '', '', 'P', '', '', '', '', ''),
('12019', 'Astari', '2', '', '', '', '', 'P', '', '', '', '', ''),
('12020', 'Ridwan Subari', '2', '', '', '', '', 'L', '', '', '', '', ''),
('12200', 'Zakia Ahmad', '2', '', '', '', '', 'L', '', '', '', '', ''),
('12021', 'Sri Haryani', '2', '', '', '', '', 'P', '', '', '', '', ''),
('5181 ', 'ABDUL RAHMAN ', '3', '', '', '', '', 'L', '', '', '', '', ''),
('5183 ', 'ADAM JULIAN FATURRAHMAN ', '3', '', '', '', '', 'L', '', '', '', '', ''),
('5186 ', 'AFRIYANTI AGUSTINI ', '3', '', '', '', '', 'P', '', '', '', '', ''),
('5192 ', 'AMALIA FADHILLAH ', '3', '', '', '', '', 'P', '', '', '', '', ''),
('5196 ', 'ARIYO SAPUTRO ', '3', '', '', '', '', 'L', '', '', '', '', ''),
('5375 ', ' Agus Marwan Setya Buda ', '4', '', '', '', '', 'L', '', '', '', '', ''),
('5376 ', ' Alfin Fikri Hakim ', '4', '', '', '', '', 'L', '', '', '', '', ''),
('5383 ', ' Deasy Eka Sari Aulia. R ', '4', '', '', '', '', 'P', '', '', '', '', ''),
('5384 ', ' Destyani Gita Prikasih ', '4', '', '', '', '', 'P', '', '', '', '', ''),
('5386 ', ' Fauzan Ibnu Hadi ', '4', '', '', '', '', 'L', '', '', '', '', ''),
('5385 ', ' Dwi Riska Lestari ', '5', '', '', '', '', 'P', '', '', '', '', ''),
('5388 ', ' Hendrajit Juniarto ', '5', '', '', '', '', 'L', '', '', '', '', ''),
('5210 ', 'HAFIZ FATURRACHMAN ', '5', '', '', '', '', 'L', '', '', '', '', ''),
('5215 ', 'INDRI LESTARI ', '5', '', '', '', '', 'P', '', '', '', '', ''),
('5219 ', 'JULIAN GUNAWAN ', '5', '', '', '', '', 'L', '', '', '', '', '');
...
(4, 'Soal latihan Bahasa Indonesia', 'Soal Latihan Bahasa Indonesia Kelas V SD', 'Bahasa. Indonesia', '', 0, '', '16/12/2012 10:25:44');
...
(2, 'Alan Ridwan M', '400001001', 'L', '-', '-', '-', '-', '-', 'Penjaskes', '4/2/1964', 'Garut', '-', '-', '0', NULL, ''),
...
(9, 'Yulianto Sri Utomo, S.Kom', '400001004', 'L', '-', '-', '-', '-', '-', '-', '-', '-', '-', '0', '0', NULL, ''),
...
('::1', '2012-11-18', 2, '1353195548'),
('::1', '2012-11-21', 1, '1353507055'),
('::1', '2012-11-23', 1, '1353662724'),
('::1', '2012-11-25', 4, '1353852984'),
('::1', '2012-11-26', 28, '1353936173'),
('::1', '2012-11-27', 17, '1354003011'),
('::1', '2012-12-15', 11, '1355585697'),
('::1', '2012-12-16', 261, '1355653639'),
('12.12.12.109', '2012-12-16', 17, '1355650094'),
('12.12.12.113', '2012-12-16', 19, '1355653670'),
('203.19.4.164', '2012-12-16', 10, '1355653358'),
('12.12.12.112', '2012-12-16', 9, '1355651446'),
('12.12.12.53', '2012-12-16', 2, '1355633842'),
('12.12.12.24', '2012-12-16', 2, '1355653286'),
('127.0.0.1', '2012-12-16', 28, '1355668450'),
('127.0.0.1', '2011-09-17', 18, '1316269188'),
('118.96.41.123', '2011-09-17', 7, '1316271711'),
('66.249.72.46', '2011-09-17', 37, '1316320710'),
('66.249.72.123', '2011-09-17', 113, '1316320610'),
...
('12.12.12.24', '2012-12-16', 2, '1355653286'),
('127.0.0.1', '2012-12-16', 28, '1355668450'),
('::1', '2013-02-19', 11, '1361282134'),
('::1', '2013-02-21', 10, '1361450477'),
('::1', '2013-03-01', 9, '1362113118'),
('::1', '2013-03-16', 1, '1363423757'),
('::1', '2013-03-17', 9, '1363497058');

-- --------------------------------------------------------

--
-- Struktur dari tabel `t_temp`
--
...
--
-- Dumping data untuk tabel `t_temp`
--

INSERT INTO `t_temp` (`id`, `judul`, `isi`) VALUES
(51, '[ Berita ] <a href="index.php?id=berita&kode=3" style="color:000000">Mendikbud: Kurikulum 2013 Tidak Ditolak</a>', 'blik <b>kurikulum</b> 2013 itu sampai tanggal 23 Desember, tapi mayoritas setuju bahwa <b>kurikulum</b> harus berubah."Menteri Pendidikan dan Kebudayaan, Mohammad Nuh, mengatakan <b>kurikulum</b> 2013 hingga kini tidak di'),
(52, '[ Berita ] <a href="index.php?id=berita&kode=4" style="color:000000">STRUKTUR KURIKULM SD 2013 </a>', 'ktur <b>kurikulum</b> baru terdiri atas dua alternatif, yaitu alternatif 1 dan alternatif 2. Kurikulum yang saat ini berlaku Terdiri atas 3 komponen A, B dan C. Kelas 1 s/d 3 diintegrasikan dalam bentuk tema'),
(53, '[ Berita ] <a href="index.php?id=berita&kode=5" style="color:000000">Belajar berbasis Online di PORTAL RUMAH BELAJAR</a>', 'pada <b>kurikulum</b> inti, serta SK-KD yang dikembangkan oleh Pusat Kurikulum.Bahan Pembelajaran Interaktif, guru dapat mengunduh multimedia pembelajaran seperti: materi pokok, modul on line, animasi, simul'),
(54, '[ Berita ] <a href="index.php?id=berita&kode=7" style="color:000000">Alternatif Mapel dan Jam Belajar di Kurikulum SD</a>', 'ntuk <b>kurikulum</b> 2013. Terjadi banyak perubahan sistem pembelajaran untuk jenjang Sekolah Dasar (SD), baik dari segi jumlah mata pelajaran atau pun jumlah jam belajar.Kurikulum 2013 yang diterapkan Juni'),
(55, '[ Berita ] <a href="index.php?id=berita&kode=8" style="color:000000">Metode Tematik Integratif Pada Kurikulum baru</a>', '. Di <b>kurikulum</b> sebelumnya pun, untuk kelas rendah seperti kelas satu, dua dan tiga sudah menggunakan&nbsp;metode pembelajaran tematik.Dalam metode tematik integratif, materi ajar tidak disampaikan ber'),
(56, '[ Berita ] <a href="index.php?id=berita&kode=9" style="color:000000">Inilah Isi Draf Perubahan Kurikulum Baru SD</a>', 'elum <b>kurikulum</b> 2013 diuji publik sekitar November 2012 dan diterapkan mulai tahun ajaran baru 2013, terlebih dahulu dipaparkan&nbsp;draf perubahan <b>kurikulum</b>&nbsp;tersebut ke Wakil Presiden RI Boediono'),
(57, '<a href= index.php?id=profil&kd=51  class=ver10 >[ Download ]</a>', '\n\r\n\r\n');

-- --------------------------------------------------------

--
-- Struktur dari tabel `t_temp_menu`
--
...
--
-- Dumping data untuk tabel `t_temp_menu`
--
...
--
-- Struktur dari tabel `t_tugas_kelas`
--
...
--
-- Struktur dari tabel `t_tugas_siswa`
--
...
--
-- Struktur dari tabel `t_voting_jawab`
--
...
--
-- Dumping data untuk tabel `t_voting_jawab`
--
...
--
-- Struktur dari tabel `t_voting_pole`
--
...
--
-- Dumping data untuk tabel `t_voting_pole`
--
...
--
-- Struktur dari tabel `t_voting_tanya`
--
...
--
-- Dumping data untuk tabel `t_voting_tanya`
--
...
(1, 'admin', '57gc0bbbfb6b3', 'alanrm82@yahoo.com', '127.0.0.1', '01:10:00 14/06/2012', 0, 1),
(2, 'aniq', 'aniq', 'aniq@yahoo.com', NULL, NULL, NULL, 1);
